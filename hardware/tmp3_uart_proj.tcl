...
#
# Generated by Vivado on Sat Oct 01 15:18:54 PDT 2022
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/export/bd_subsystem_wrapper.dcp"]"\
  ]
  foreach ifile $files {
 ...
 "[file normalize "$origin_dir/constr/zybo-master-constr.xdc"]"\
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../test/tmp3_uart_proj/hardware/[file normalize "$origin_dir/ip_repo"]"]"\
  ]
  foreach ipath $paths {
...
preplace netloc processing_system7_0_FCLK_CLK0 1 1 3 240 280 630 50 970
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 250 480 640
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 2 2 650 330 980
...
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 640 110n
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 960 60n
